# Deferred WLED and Madrix hardware setup

> This document preserves the older WLED/Madrix bench path. It is not the
> current Lightweaver product setup. The active product runs signed Lightweaver
> firmware directly on the ESP32-S3. Use
> [`hardware-setup.md`](hardware-setup.md) for current cards.
