...
void handleRoot() {
  ...
  page += F("</title>"
            ...
            ".sw{height:64px;border-radius:8px;overflow:hidden;background-color:#262626;-webkit-transform:translateZ(0);transform:translateZ(0);will-change:background-position}"
