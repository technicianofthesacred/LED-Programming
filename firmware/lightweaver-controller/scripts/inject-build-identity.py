...
# The human-facing firmware identity: first-parent Git depth of the same source
# revision, so a card can answer "which build am I on?" with a number the owner
# can compare against the published release instead of a 40-character hash.
