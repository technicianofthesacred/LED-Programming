...
function App() {
  ...
  const Screen = { pattern: window.PatternScreen, playlist: window.PlaylistScreen, layout: window.LayoutScreen, show: window.ShowScreen, flash: window.FlashScreen, settings: window.SettingsScreen, installer: window.InstallerScreen }[view];
